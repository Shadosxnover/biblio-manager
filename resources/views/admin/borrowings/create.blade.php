...
<div class="admin-layout">
    ...
    <div class="admin-content p-4 md:p-6 lg:p-8">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 mb-1">Create New Borrowing</h1>
            <p class="text-gray-600">Add a new borrowing record to the system</p>
        </div>
        ...
        <div class="bg-white shadow-md rounded-lg overflow-hidden">
            <div class="bg-gray-50 px-6 py-4 border-b border-gray-200">
                <h2 class="text-lg font-medium text-gray-900">Borrowing Form</h2>
            </div>
            <div class="p-6">
                <form action="{{ route('admin.borrowings.store') }}" method="POST">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        <div>
                            ...
                            <select name="user_id" id="user_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" required>
                        ...
                        <div>
                            ...
                            <select name="book_id" id="book_id" class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50" required>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                        ...
                        <div>
                            <label for="return_date" class="block text-sm font-medium text-gray-700 mb-2">Return Due Date:</label>
                            <input type="date" name="return_date" id="return_date" 
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring focus:ring-primary focus:ring-opacity-50"
                                value="{{ old('return_date', date('Y-m-d', strtotime('+14 days'))) }}" required>
                            @error('return_date')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="flex justify-end mt-8 space-x-3">
                        ...
                        <button type="submit" class="bg-primary hover:bg-primary-dark text-white font-medium py-2 px-4 rounded-md transition-colors shadow-sm">
                            Create Borrowing
                        </button>
                    </div>
                </form>
