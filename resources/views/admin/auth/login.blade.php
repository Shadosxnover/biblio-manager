...
<div class="min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
    <div class="login-form bg-white rounded-lg shadow-lg p-8">
        ...
        <form method="POST" action="{{ route('admin.login') }}" class="w-full">
            ...
            <div>
                <button type="submit" class="w-full bg-primary hover:bg-gray-800 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Login as Admin
                </button>
            </div>
        </form>
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('login') }}" class="text-primary hover:underline">Log in as regular user</a>
        </div>
    </div>
</div>
@endsection
