...
@section('admin-content')
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-primary">Categories Management</h2>
        <a href="{{ route('admin.categories.create') }}" class="bg-primary hover:bg-red-700 text-white py-2 px-4 rounded">Add New Category</a>
    </div>
